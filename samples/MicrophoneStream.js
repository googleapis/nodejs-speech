...
require(`yargs`)
  ...
  .example(`node $0 test_1 ManualTest.wav -t 5`)
  .example(`node $0 wavFileToText ManualTest.wav -e LINEAR16 -r 16000 -l en-US`)
  .example(
    `node $0 micStreamRecognize ManualTest.wav -t 10 -e LINEAR16 -r 16000`
  )
