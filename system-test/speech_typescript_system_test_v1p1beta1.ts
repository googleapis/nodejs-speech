...
describe('SpeechClient TypeScript system test v1p1beta1', () => {
  it('calls recognize', async () => {
    ...
    const encoding = google.cloud.speech.v1p1beta1.RecognitionConfig.AudioEncoding.FLAC;
    const config = {
      languageCode,
      sampleRateHertz,
      encoding,
  ...
  it('calls streamingRecognize', done => {
    ...
    stream.on('data', (response: google.cloud.speech.v1p1beta1.IStreamingRecognizeResponse) => {
      assert.strictEqual(
