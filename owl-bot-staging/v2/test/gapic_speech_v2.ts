...
describe('v2.SpeechClient', () => {
    ...
    describe('getRecognizer', () => {
        it('invokes getRecognizer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRecognizerRequest', ['name']);
    ...
    describe('recognize', () => {
        it('invokes recognize without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RecognizeRequest', ['recognizer']);
    ...
    describe('getConfig', () => {
        it('invokes getConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateConfig', () => {
        it('invokes updateConfig without error', async () => {
            ...
            request.config ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateConfigRequest', ['config', 'name']);
    ...
    describe('getCustomClass', () => {
        it('invokes getCustomClass without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetCustomClassRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getPhraseSet', () => {
        it('invokes getPhraseSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetPhraseSetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createRecognizer', () => {
        it('invokes createRecognizer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateRecognizerRequest', ['parent']);
    ...
    describe('updateRecognizer', () => {
        it('invokes updateRecognizer without error', async () => {
            ...
            request.recognizer ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateRecognizerRequest', ['recognizer', 'name']);
    ...
    describe('deleteRecognizer', () => {
        it('invokes deleteRecognizer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteRecognizerRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('undeleteRecognizer', () => {
        it('invokes undeleteRecognizer without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UndeleteRecognizerRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('batchRecognize', () => {
        it('invokes batchRecognize without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('BatchRecognizeRequest', ['recognizer']);
            request.recognizer = defaultValue1;
            const expectedHeaderRequestParams = `recognizer=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createCustomClass', () => {
        it('invokes createCustomClass without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateCustomClassRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateCustomClass', () => {
        it('invokes updateCustomClass without error', async () => {
            ...
            request.customClass ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateCustomClassRequest', ['customClass', 'name']);
    ...
    describe('deleteCustomClass', () => {
        it('invokes deleteCustomClass without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteCustomClassRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('undeleteCustomClass', () => {
        it('invokes undeleteCustomClass without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UndeleteCustomClassRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createPhraseSet', () => {
        it('invokes createPhraseSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreatePhraseSetRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updatePhraseSet', () => {
        it('invokes updatePhraseSet without error', async () => {
            ...
            request.phraseSet ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdatePhraseSetRequest', ['phraseSet', 'name']);
    ...
    describe('deletePhraseSet', () => {
        it('invokes deletePhraseSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeletePhraseSetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('undeletePhraseSet', () => {
        it('invokes undeletePhraseSet without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UndeletePhraseSetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listRecognizers', () => {
        it('invokes listRecognizers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRecognizersRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listCustomClasses', () => {
        it('invokes listCustomClasses without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListCustomClassesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listPhraseSets', () => {
        it('invokes listPhraseSets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListPhraseSetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
