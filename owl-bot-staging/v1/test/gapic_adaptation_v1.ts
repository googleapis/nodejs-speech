...
describe('v1.AdaptationClient', () => {
    ...
    describe('createPhraseSet', () => {
        it('invokes createPhraseSet without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.speech.v1.CreatePhraseSetRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.speech.v1.PhraseSet());
    ...
    describe('getPhraseSet', () => {
        it('invokes getPhraseSet without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.speech.v1.GetPhraseSetRequest());
            request.name = '';
    ...
    describe('deletePhraseSet', () => {
        it('invokes deletePhraseSet without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.speech.v1.DeletePhraseSetRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createCustomClass', () => {
        it('invokes createCustomClass without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.speech.v1.CreateCustomClassRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.speech.v1.CustomClass());
    ...
    describe('getCustomClass', () => {
        it('invokes getCustomClass without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.speech.v1.GetCustomClassRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updateCustomClass', () => {
        it('invokes updateCustomClass without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.speech.v1.UpdateCustomClassRequest());
            request.customClass = {};
    ...
    describe('listPhraseSet', () => {
        it('invokes listPhraseSet without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.speech.v1.ListPhraseSetRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listCustomClasses', () => {
        it('invokes listCustomClasses without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.speech.v1.ListCustomClassesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
